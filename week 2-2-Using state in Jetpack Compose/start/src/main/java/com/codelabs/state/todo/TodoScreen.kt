...
fun TodoInputTextField(
    ...
    TodoInputText(text, onTextChange, modifier, onComplete)
}
...
fun TodoScreen(
    ...
    Column {
        val enableHeader = currentlyEditing == null
        TodoItemInputBackground(elevate = enableHeader, modifier = Modifier.fillMaxWidth()) {
            if (enableHeader) {
